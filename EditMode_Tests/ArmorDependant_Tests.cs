...
namespace AF.Tests
{
    ...
    public class ArmorDependant_Tests : MonoBehaviour
    {
        ...
        public void ShouldActivateChildren_IfArmorIsEquipped_AndOnlyArmorIsRequiredToBeEquipped()
        {
            ...
            equipmentDatabase.armor = new ArmorInstance("", ironArmor);
            ...
            equipmentDatabase.armor = new ArmorInstance("", steelArmor);
        ...
        public void ShouldActivateChildren_IfAllArmorIsEquipped_AndAllrmorIsRequiredToBeEquipped()
        {
            ...
            equipmentDatabase.helmet = new HelmetInstance("", ironHelmet);
            equipmentDatabase.legwear = new LegwearInstance("", ironLegwear);
            equipmentDatabase.gauntlet = new GauntletInstance("", ironGauntlet);
        ...
        public void ShouldActivateChildren_IfNoArmorIsEquipped_AndPlayerIsRequiredToBeNaked()
        {
            ...
            equipmentDatabase.gauntlet = new GauntletInstance("", steelGauntlet);
