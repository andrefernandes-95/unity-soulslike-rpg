    ...
    public class UIDocumentLevelUp : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            UIUtils.SetupButton(root.Q<Button>("ConfirmButton"), () =>
            {
                ...
                if (oldLevel != newLevel)
                {
                    ...
                    notificationManager.ShowNotification(LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "You leveled up!"), notificationManager.levelUp);
                }
        ...
        void DrawUI(VisualElement root)
        {
            ...
            root.Q<VisualElement>("PhysicalAttackPower").Q<Label>("Value").text =
                playerManager.equipmentDatabase.GetUnarmedWeapon().weaponDamage.GetCurrentDamage(
                    playerManager,
                    desiredStrength,
                    desiredDexterity,
                    desiredIntelligence,
