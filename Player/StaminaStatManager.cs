    ...
    public class StaminaStatManager : MonoBehaviour
    {
        ...
        public int GetMaxStamina()
        {
            return Formulas.CalculateStatForLevel(
                 playerManager.combatant.stamina + playerStatsBonusController.staminaBonus,
        ...
        {
            return playerManager.combatant.stamina + (int)Mathf.Ceil(endurance * playerStatsDatabase.levelMultiplierForStamina);
        }
        ...
        public void DecreaseLightAttackStamina()
        {
            DecreaseStamina(
                equipmentDatabase.GetCurrentWeapon().Exists()
                    ? equipmentDatabase.GetCurrentWeapon().GetItem()?.lightAttackStaminaCost ?? unarmedLightAttackStaminaCost
        ...
        public void DecreaseHeavyAttackStamina()
        {
            DecreaseStamina(
                equipmentDatabase.GetCurrentWeapon().Exists()
                    ? equipmentDatabase.GetCurrentWeapon().GetItem()?.heavyAttackStaminaCost ?? unarmedLightAttackStaminaCost
                    : unarmedHeavyAttackStaminaCost);
        }

        public bool HasEnoughStaminaForLightAttack()
        {
            var staminaCost = equipmentDatabase.GetCurrentWeapon().Exists()
                ? equipmentDatabase.GetCurrentWeapon().GetItem()?.lightAttackStaminaCost ?? unarmedLightAttackStaminaCost : unarmedLightAttackStaminaCost;
        ...
        {
            var staminaCost = equipmentDatabase.GetCurrentWeapon().Exists()
                ? equipmentDatabase.GetCurrentWeapon().GetItem()?.heavyAttackStaminaCost ?? unarmedHeavyAttackStaminaCost : unarmedHeavyAttackStaminaCost;
