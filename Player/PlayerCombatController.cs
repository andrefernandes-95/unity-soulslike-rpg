namespace AF
{
    ...
    public class PlayerCombatController : MonoBehaviour
    {
        ...
        {
            Weapon currentWeapon = isAttackingWithLeftHand ? equipmentDatabase.GetCurrentSecondaryWeapon().GetItem() : equipmentDatabase.GetCurrentWeapon().GetItem();
            if (currentWeapon == null) currentWeapon = equipmentDatabase.GetUnarmedWeapon();
