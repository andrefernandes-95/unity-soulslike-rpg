...
namespace AF
{
    ...
    public class PlayerStatsAndAttributesUI : MonoBehaviour
    {
        ...
        public void DrawStats(ItemInstance itemInstance)
        {
            ...
            if (equipmentDatabase.IsUnarmed())
            {
                currentWeaponInstance = equipmentDatabase.unarmedWeaponInstance;
                currentWeapon = equipmentDatabase.GetUnarmedWeapon();
            }

            WeaponInstance weaponInstanceToEquip = itemInstance as WeaponInstance;
            Weapon weaponToEquip = itemInstance != null ? itemInstance.GetItem() as Weapon : null;
            ...
            SetAttackLabels(weaponInstanceToEquip, "FireAttack", WeaponElementType.Fire);
            SetAttackLabels(weaponInstanceToEquip, "FrostAttack", WeaponElementType.Frost);
            SetAttackLabels(weaponInstanceToEquip, "LightningAttack", WeaponElementType.Lightning);
            SetAttackLabels(weaponInstanceToEquip, "MagicAttack", WeaponElementType.Magic);
            SetAttackLabels(weaponInstanceToEquip, "DarknessAttack", WeaponElementType.Darkness);
            SetAttackLabels(weaponInstanceToEquip, "WaterAttack", WeaponElementType.Water);
        ...
        private void SetAttackLabels(WeaponInstance weaponInstance, string labelName, WeaponElementType elementType)
        {
            ...
            int itemValue = EquipmentUtils.GetElementalAttackForCurrentWeapon(
                weaponInstance, elementType, playerManager.attackStatManager);
