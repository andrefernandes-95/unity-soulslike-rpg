    ...
    public class ItemTooltip : MonoBehaviour
    {
        ...
        */
        ...
        void DrawWeaponEffects(WeaponInstance weaponInstance)
        {
            ...
            int playerDexterity = playerManager.statsBonusController.GetCurrentDexterity();
            int playerIntelligence = playerManager.statsBonusController.GetCurrentIntelligence();
        ...
        {
            Shield shield = shieldInstance.GetItem();
        ...
        {
            ArmorBase armor = armorBaseInstance.GetItem();
        ...
        {
            CraftingMaterial craftingMaterial = craftingMaterialInstance.GetItem();
        ...
        {
            UpgradeMaterial upgradeMaterial = upgradeMaterialInstance.GetItem();
        ...
        {
            Consumable consumable = consumableInstance.GetItem();
